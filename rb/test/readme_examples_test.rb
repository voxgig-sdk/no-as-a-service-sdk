...
#      offline in seeded test mode (NoAsAServiceSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "NoAsAService_sdk.rb")
  SDK_CLASS = "NoAsAServiceSDK"
