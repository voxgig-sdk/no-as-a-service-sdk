...
// NoAsAService SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class NoAsAServiceTransformResponse
{
    public static function call(NoAsAServiceContext $ctx): mixed
    {
        ...
        $transform = NoAsAServiceHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
