...
// NoAsAService SDK utility: fetcher

class NoAsAServiceFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; NoAsAServiceSDK/1.0)';
    ...
    public static function call(NoAsAServiceContext $ctx, string $fullurl, array $fetchdef): array
    {
