...
// NoAsAService SDK clienttrack feature
...
class NoAsAServiceClienttrackFeature extends NoAsAServiceBaseFeature
{
    ...
    public function PostConstruct(NoAsAServiceContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'NoAsAService-SDK';
