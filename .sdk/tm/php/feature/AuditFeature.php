...
// NoAsAService SDK audit feature
...
class NoAsAServiceAuditFeature extends NoAsAServiceBaseFeature
{
    ...
    private function _emit(NoAsAServiceContext $ctx, string $outcome): void
    {
