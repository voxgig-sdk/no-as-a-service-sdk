...
// NoAsAService SDK timeout feature
...
class NoAsAServiceTimeoutFeature extends NoAsAServiceBaseFeature
{
    ...
    private function _with_timeout(NoAsAServiceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(NoAsAServiceContext $_ctx, float $ms): void
    {
        $client = $this->client;
