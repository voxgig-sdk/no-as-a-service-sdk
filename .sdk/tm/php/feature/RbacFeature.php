...
class NoAsAServiceRbacFeature extends NoAsAServiceBaseFeature
{
    ...
    private function _required(NoAsAServiceContext $ctx): ?string
    {
    ...
    private function _reject(NoAsAServiceContext $ctx, string $required): void
    {
    ...
    private function _track(NoAsAServiceContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
