...
// NoAsAService SDK proxy feature
...
class NoAsAServiceProxyFeature extends NoAsAServiceBaseFeature
{
    ...
    public function init(NoAsAServiceContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (NoAsAServiceContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
