...
// NoAsAService SDK metrics feature
...
class NoAsAServiceMetricsFeature extends NoAsAServiceBaseFeature
{
    ...
    private function _record(NoAsAServiceContext $ctx, bool $ok): void
    {
