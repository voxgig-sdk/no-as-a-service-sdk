...
def make_error_util(ctx, err):
    if ctx is None:
        from projectname_sdk.core.context import NoAsAServiceContext
        ctx = NoAsAServiceContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, NoAsAServiceError):
        errmsg = err.msg
    ...
    sdk_err = NoAsAServiceError("", msg, ctx)
