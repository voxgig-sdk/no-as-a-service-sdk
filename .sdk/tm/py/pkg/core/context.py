...
from projectname_sdk.core.control import NoAsAServiceControl
...
class NoAsAServiceContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, NoAsAServiceSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, NoAsAServiceResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, NoAsAServiceResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return NoAsAServiceError(code, msg, self)
