...
class NoAsAServiceTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = NoAsAServiceTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = NoAsAServiceTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = NoAsAServiceTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
