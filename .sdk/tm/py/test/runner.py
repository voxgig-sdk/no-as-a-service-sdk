...
class NoAsAServiceTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = NoAsAServiceTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = NoAsAServiceTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = NoAsAServiceTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
