...
|---|---|---|
| `ts/` | @voxgig-sdk/no-as-a-service-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/no-as-a-service-sdk \
      --repository voxgig-sdk/no-as-a-service-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/no-as-a-service-sdk` shows it, and
`npm trust revoke @voxgig-sdk/no-as-a-service-sdk --id=<id>` removes it.
