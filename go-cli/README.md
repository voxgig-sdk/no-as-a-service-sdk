...
AQL-driven CLI and REPL for the NoAsAService SDK. Positional arguments are
...
```sh
go build -o no-as-a-service-cli ./...
```
...
./no-as-a-service-cli list non
./no-as-a-service-cli load 1 non
./no-as-a-service-cli load '{id:1}' non
