...
func registerSDKWords(r *eng.Registry, client *sdk.NoAsAServiceSDK) {
...
func runOp(client *sdk.NoAsAServiceSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
