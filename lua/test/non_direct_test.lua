...
describe("NonDirect", function()
  it("should direct-load-non", function()
    local setup = non_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-non", setup.live and "live" or "unit")
