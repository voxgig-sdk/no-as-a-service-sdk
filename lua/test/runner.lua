...
function runner.env_override(m)
  local live = runner.getenv("NO_AS_A_SERVICE_TEST_LIVE")
  local override = runner.getenv("NO_AS_A_SERVICE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("NO_AS_A_SERVICE_TEST_EXPLAIN")
