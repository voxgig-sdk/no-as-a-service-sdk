...
import (
	...
	vs "github.com/voxgig-sdk/no-as-a-service-sdk/go/utility/struct"
)

type NonEntity struct {
	name    string
	client  *core.NoAsAServiceSDK
...
func NewNonEntity(client *core.NoAsAServiceSDK, entopts map[string]any) *NonEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NonEntity) GetName() string { return e.name }
...
func (e *NonEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NonEntity) Deleted() bool {
	return e.deleted
}


func (e *NonEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNonEntity(e.client, opts)
}

func (e *NonEntity) Data(args ...any) any {
...
func (e *NonEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Non; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *NonEntity) DataTyped(data ...Non) Non {
	if len(data) > 0 {
		return typedFrom[Non](e.Data(asMap(data[0])))
	}
	return typedFrom[Non](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Non (all fields
// optional at the wire level).
func (e *NonEntity) MatchTyped(match ...Non) Non {
	if len(match) > 0 {
		return typedFrom[Non](e.Match(asMap(match[0])))
	}
	return typedFrom[Non](e.Match())
}
...
func (e *NonEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NonEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// NonLoadMatch and returns an Non. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *NonEntity) LoadTyped(reqmatch NonLoadMatch, ctrl map[string]any) (Non, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Non{}, err
	}
	return typedFrom[Non](res), nil
}



func (e *NonEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *NonEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *NonEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *NonEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *NonEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
