# NoAsAService SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions NoAsAServiceSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both NoAsAServiceSDK(...) and NoAsAServiceSDK.test(...) become
#      NoAsAServiceSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "noasaservice_sdk"
_SDK_CLASS = "NoAsAServiceSDK"
