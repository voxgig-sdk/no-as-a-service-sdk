...
from noasaservice_sdk.utility import register

# Load features
from noasaservice_sdk.feature.base_feature import NoAsAServiceBaseFeature
from noasaservice_sdk.features import _has_feature, _make_feature
...
class NoAsAServiceSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = NoAsAServiceUtility()
        self._utility = utility

        from noasaservice_sdk.config import shared_config
    ...
    def get_utility(self):
        return NoAsAServiceUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("NoAsAServiceSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Non(self, data=None) -> "NonEntity":
        ...
        from noasaservice_sdk.entity.non_entity import NonEntity
