...
type Args struct {
	Entity string         `json:"entity" jsonschema:"non"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.NoAsAServiceSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "no-as-a-service_list",
		Description: "List records from NoAsAService. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "no-as-a-service_load",
		Description: "Load a single record from NoAsAService. " +
...
func runOp(client *sdk.NoAsAServiceSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.NoAsAServiceSDK, name string) (sdk.NoAsAServiceEntity, error) {
	switch strings.ToLower(name) {
	case "non":
		return client.Non(nil), nil
