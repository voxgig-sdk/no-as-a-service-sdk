// Command NoAsAService-mcp is an MCP server exposing the NoAsAService
// SDK as MCP tools.
//
// Two tools are registered:
//
//	NoAsAService_list  — list records of an entity
//	NoAsAService_load  — load a single record of an entity
//
