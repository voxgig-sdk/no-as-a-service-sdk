...
// NoAsAService SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = NoAsAServiceOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(NoAsAServiceOmni::structfix($now, Struct::undef()))
                        !== json_encode(NoAsAServiceOmni::structfix($val, Struct::undef()))) {
