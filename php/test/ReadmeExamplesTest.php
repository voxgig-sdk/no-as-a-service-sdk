...
// NoAsAService SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (NoAsAServiceSDK::test)
...
{
    private const SDK_CLASS = 'NoAsAServiceSDK';
    ...
    private const SDK_BASE = 'noasaservice_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../noasaservice_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
