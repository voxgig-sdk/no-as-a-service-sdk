...
// NoAsAService SDK pipeline test
//
...
{
    private static function utility(): NoAsAServiceUtility
    {
        return new NoAsAServiceUtility();
    }
    ...
    private static function ctx(array $over = []): NoAsAServiceContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new NoAsAServiceContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new NoAsAServiceOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof NoAsAServiceError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new NoAsAServiceOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = NoAsAServiceMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new NoAsAServiceOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = NoAsAServiceMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new NoAsAServiceOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = NoAsAServiceMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NoAsAServiceSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = NoAsAServiceMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        ...
        [, $err] = NoAsAServiceMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new NoAsAServiceSpec([]),
            'response' => null,
            'result' => new NoAsAServiceResult([]),
        ]);
        [, $err] = NoAsAServiceMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new NoAsAServiceSpec(['step' => 's']),
            'response' => new NoAsAServiceResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new NoAsAServiceResult([]),
        ]);
        [, $err] = NoAsAServiceMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new NoAsAServiceSpec(['step' => 's']),
            'response' => new NoAsAServiceResponse(self::resp(200, ['v' => 1])),
            'result' => new NoAsAServiceResult([]),
        ]);
        [, $err] = NoAsAServiceMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new NoAsAServiceSpec(['step' => 's']),
            'response' => new NoAsAServiceResponse(self::resp(200, ['v' => 2])),
            'result' => new NoAsAServiceResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        NoAsAServiceMakeResponse::call($ctx);
    ...
    {
        $preset = new NoAsAServiceResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new NoAsAServiceSpec([]),
            'response' => new NoAsAServiceResponse([]),
            'result' => new NoAsAServiceResult([]),
        ...
        [$got, $err] = NoAsAServiceMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new NoAsAServiceResult([])]);
        [, $err] = NoAsAServiceMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new NoAsAServiceSpec([]), 'result' => null]);
        [, $err] = NoAsAServiceMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NoAsAServiceSpec(['step' => 's']),
            'result' => new NoAsAServiceResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new NoAsAServiceOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NoAsAServiceMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NoAsAServiceSpec(['step' => 's']),
            'result' => new NoAsAServiceResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new NoAsAServiceOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NoAsAServiceMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NoAsAServiceResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new NoAsAServiceSpec([]),
            'result' => new NoAsAServiceResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = NoAsAServiceMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NoAsAServiceMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new NoAsAServiceError('boom', 'boom');
        $utility->fetcher = function (NoAsAServiceContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NoAsAServiceSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = NoAsAServiceMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (NoAsAServiceContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = NoAsAServiceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(NoAsAServiceResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        NoAsAServiceMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (NoAsAServiceContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NoAsAServiceSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = NoAsAServiceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new NoAsAServiceResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new NoAsAServiceSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = NoAsAServiceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = NoAsAServiceMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = NoAsAServiceMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new NoAsAServiceResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, NoAsAServiceDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new NoAsAServiceResult(['ok' => false])]);
        $this->expectException(NoAsAServiceError::class);
        NoAsAServiceDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new NoAsAServiceResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', NoAsAServiceMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        NoAsAServiceMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new NoAsAServiceBaseFeature();
        $b = new NoAsAServiceBaseFeature();
        NoAsAServiceFeatureAdd::call($ctx, $a);
        NoAsAServiceFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): NoAsAServiceBaseFeature
    {
        $f = new NoAsAServiceBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        NoAsAServiceFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): NoAsAServiceContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new NoAsAServiceSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NoAsAServicePrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        NoAsAServicePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new NoAsAServiceResponse(['headers' => null]),
            'result' => new NoAsAServiceResult([]),
        ]);
        NoAsAServiceResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        NoAsAServiceResultBody::call($ctx);
