...
// NoAsAService SDK idempotency feature
...
class NoAsAServiceIdempotencyFeature extends NoAsAServiceBaseFeature
{
    ...
    private function _mutating(NoAsAServiceContext $ctx): bool
    {
