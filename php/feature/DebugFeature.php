...
// NoAsAService SDK debug feature
...
class NoAsAServiceDebugFeature extends NoAsAServiceBaseFeature
{
    ...
    private function _finish(NoAsAServiceContext $ctx, bool $ok): void
    {
