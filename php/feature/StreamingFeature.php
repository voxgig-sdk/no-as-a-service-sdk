...
// NoAsAService SDK streaming feature
...
class NoAsAServiceStreamingFeature extends NoAsAServiceBaseFeature
{
    ...
    private function _iterate(NoAsAServiceResult $result): \Generator
    {
    ...
    private function _streamable(NoAsAServiceContext $ctx): bool
    {
