...
// NoAsAService SDK ratelimit feature
...
class NoAsAServiceRatelimitFeature extends NoAsAServiceBaseFeature
{
    ...
    private function _acquire(NoAsAServiceContext $ctx): void
    {
    ...
    private function _track(NoAsAServiceContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
