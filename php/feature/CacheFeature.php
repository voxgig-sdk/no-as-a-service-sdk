...
// NoAsAService SDK cache feature
...
class NoAsAServiceCacheFeature extends NoAsAServiceBaseFeature
{
    ...
    private function _through(NoAsAServiceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
