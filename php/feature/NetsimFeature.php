...
// NoAsAService SDK netsim feature
...
class NoAsAServiceNetsimFeature extends NoAsAServiceBaseFeature
{
    ...
    private function _simulate(NoAsAServiceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(NoAsAServiceContext $ctx, array $applied): void
    {
        $client = $this->client;
