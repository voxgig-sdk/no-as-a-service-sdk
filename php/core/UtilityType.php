...
// NoAsAService SDK utility type

class NoAsAServiceUtility
{
    ...
    public static function copy(NoAsAServiceUtility $src): NoAsAServiceUtility
    {
        $u = new NoAsAServiceUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
