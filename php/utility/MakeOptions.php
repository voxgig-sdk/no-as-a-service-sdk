...
// NoAsAService SDK utility: make_options

class NoAsAServiceMakeOptions
{
    ...
    public static function call(NoAsAServiceContext $ctx): array
    {
        ...
        //
        // `NoAsAServiceSchema::optspec()` is built from the model:
        ...
        $optspec = NoAsAServiceSchema::optspec();
