...
// NoAsAService SDK utility: graphql
//
...
class NoAsAServiceGraphql
{
    ...
    // equivalent.
    public static function body(NoAsAServiceContext $ctx): mixed
    {
    ...
    public static function errors(NoAsAServiceContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
