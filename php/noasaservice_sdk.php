...
class NoAsAServiceSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = NoAsAServiceHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = NoAsAServiceHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!NoAsAServiceFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, NoAsAServiceFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return NoAsAServiceUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = NoAsAServiceHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = NoAsAServiceHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = NoAsAServiceHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new NoAsAServiceError($op . "_allow",
                "NoAsAServiceSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = NoAsAServiceHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new NoAsAServiceError("graphql_error",
                "NoAsAServiceSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Non($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_non === null) {
                $this->_non = new NonEntity($this, null);
            }
            return $this->_non;
        }
        return new NonEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new NoAsAServiceSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
