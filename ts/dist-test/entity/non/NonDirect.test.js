...
(0, node_test_1.describe)('NonDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.NoAsAServiceSDK({
    ...
    (0, node_test_1.test)('direct-load-non', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-non', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.NO_AS_A_SERVICE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.NoAsAServiceSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['NO_AS_A_SERVICE_TEST_NON_ENTID'];
    ...
    const client = new __1.NoAsAServiceSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=NonDirect.test.js.map