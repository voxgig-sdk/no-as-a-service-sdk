...
function envOverride(m) {
    if ('TRUE' === process.env.NO_AS_A_SERVICE_TEST_LIVE ||
        'TRUE' === process.env.NO_AS_A_SERVICE_TEST_OVERRIDE) {
    ...
    m.NO_AS_A_SERVICE_TEST_EXPLAIN = process.env.NO_AS_A_SERVICE_TEST_EXPLAIN || m.NO_AS_A_SERVICE_TEST_EXPLAIN;
    return m;
}
