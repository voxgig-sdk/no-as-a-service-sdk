...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/no-as-a-service` | `npm install @voxgig-sdk/no-as-a-service` |
| Python | `voxgig-sdk-no-as-a-service` | `pip install voxgig-sdk-no-as-a-service` |
| PHP | `voxgig-sdk/no-as-a-service` | `composer require voxgig-sdk/no-as-a-service` |
| Golang | `github.com/voxgig-sdk/no-as-a-service-sdk/go` | `go get github.com/voxgig-sdk/no-as-a-service-sdk/go` |
| Ruby | `voxgig-sdk-no-as-a-service` | `gem install voxgig-sdk-no-as-a-service` |
| Lua | `voxgig-sdk-no-as-a-service` | `luarocks install voxgig-sdk-no-as-a-service` |
